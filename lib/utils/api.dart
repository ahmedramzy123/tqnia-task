...
class DioHelper {
  ...
  static Future<Response> postData({
    ...
    dio.options.headers = {
      'Authorization': 'Bearer AAAAZInI3c4:APA91bF_N1Lz1jDy38jPt1GG6Jnj94_zkdheBYXOQ2KAEG9O4QzBPwS4xRtK5k_wU5N3-gYIGceIrpWzxa2gmk0oDXLhTDt9gaZv_mDGJB1JTqnpeKyr8y3rn8ZnbRUdJzk4H66znTWw',
    };
    debugPrint("-------------End Point----------------");
    debugPrint(url);
    debugPrint("-------------End Point----------------");
